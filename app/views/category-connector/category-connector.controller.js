angular.module('orionEcommerceApp')
    .controller('CategoryConnectorCtrl', function($filter, $timeout, $scope, productService, toastr, PRODUCT_LOAD_LIMIT) {
        var vm = this;
        ...
        vm.getProducts = function() {
            ...
            productService.getProducts('connector', vm.params)
                .then(function(res) {
        ...
        vm.inputTypes = [
            { name: 'Adapter', ticked: false },
            { name: 'Lightning (iPhone)', ticked: false },
            { name: 'Micro USB', ticked: false },
            { name: 'Type C', ticked: false },
        ];
