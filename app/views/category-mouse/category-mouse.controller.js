angular.module('orionEcommerceApp')
    .controller('CategoryMouseCtrl', function($filter, $timeout, $scope, productService, toastr, PRODUCT_LOAD_LIMIT) {
        var vm = this;
        ...
        vm.getProducts = function() {
            ...
            productService.getProducts('mouse', vm.params)
                .then(function(res) {
        ...
        vm.inputTypes = [
            { name: 'Chuột không dây', ticked: false },
            { name: 'Chuột có dây', ticked: false },
        ];
